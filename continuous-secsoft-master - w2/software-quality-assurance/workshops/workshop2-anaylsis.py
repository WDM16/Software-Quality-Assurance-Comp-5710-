...
def checkFlow(data, code):
    ...
    if os.path.exists(code):
        ...
        for var in fullVarList:
            ...
            elif isinstance(var[1], str) and "res" in var[1]:
                taint_trace[var[1]] = var[0]
