...
def makeConn():
    hvc_client = client = hvac.Client(url='http://127.0.0.1:8200', token='hvs.nDMsbqX8OOa5x6g7p31JKSLy' ) 
    return hvc_client 
...
if __name__ == '__main__': 
    clientObj    =  makeConn() 
    secret2store = 'root_user', 'test_password', 'ghp_ahAyHoRwoQ', 'MTIzANO=', 't5f28U'
